...
9. Run "grunt specs" to test your code - this will include SCSS Lint, JS Hint, and Jasmine
...
* Directories:
	...
	* Configuration: Compass and SCSS Lint configuration files
	* Data: Any application JSON you may have stored
	* Dependencies (generated by Bower): All Bower dependencies
	...
	* WWW (generated by Grunt tasks): Production files
